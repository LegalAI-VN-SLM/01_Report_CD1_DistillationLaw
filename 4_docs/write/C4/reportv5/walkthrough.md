...
| Tên Run | Mô Phân Nhóm | Kích Thước | LR | Alpha | Temp | MC Acc (▲) | NLI Acc (▲) | NLI F1 | Syl RougeL (▲) | Runtime (s) | Best Overall (▲) |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **B2_sft_0.6b** *(baseline)* | QLoRA SFT | 0.6B | 2.0e-4 | - | - | 0.1400 | 0.7160 | 0.4730 | 0.4280 | 473 | 0.42820 |
| **A2_offline_kd** | QLoRA V2 (KD V2) | 0.6B | 2.0e-5 | 0.3 | 1.5 | 0.4158 | 0.5886 | 0.4390 | 0.3804 | 5,016 | **0.46217** |
| **A1_offline_kd** | LoRA V2 (KD V2) | 0.6B | 2.0e-5 | 0.3 | 1.5 | 0.4059 | 0.2270 | 0.2416 | 0.1741 | 3,817 | **0.45196** |
| **A2_onpolicy_onpolicy_kd_multigpu** | On-Policy KD | 0.6B | 2.0e-5 | 0.5 | 2.0 | 0.1600 | 0.4960 | 0.3800 | 0.2750 | 39,150 | **0.31040** |
| **A2_dpo** | DPO Alignment | 0.6B | 5.0e-6 | - | - | 0.1000 | 0.3191 | 0.2387 | 0.1392 | 3,165 | **0.18613** |
| **B3_sft_1.7b** *(baseline)* | LoRA SFT | 1.7B | 2.0e-4 | - | - | 0.5000 | 0.7450 | 0.5040 | 0.2070 | 592 | 0.48400 |
| **A3_offline_kd** | LoRA V2 (KD V2) | 1.7B | 2.0e-5 | 0.3 | 1.5 | 0.4455 | 0.7305 | 0.5018 | 0.4208 | 4,741 | **0.53220** |
| **A3_onpolicy_onpolicy_kd** | On-Policy KD | 1.7B | 2.0e-5 | 0.5 | 2.0 | 0.3600 | 0.7870 | 0.5310 | 0.3750 | 14,278 | **0.50750** |
| **A3_dpo** | DPO Alignment | 1.7B | 5.0e-6 | - | - | 0.2000 | 0.8156 | 0.8333 | 0.5684 | 4,755 | **0.52802** |
